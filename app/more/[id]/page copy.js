...
export const generateMetadata = async ({ params }) => {
  const res = await fetch(
    `https://filmvaultbackend-xpgy.onrender.com/get-item-detailsS/${params.id}`,
    {
      next: { revalidate: 60 },
    }
  );
...
const page = async ({ params }) => {
  ...
  const res9 = await axios.all([
    axios.get(
      `https://filmvaultbackend-xpgy.onrender.com/get-related-contentS/${category1}`
    ),
    axios.get(
      `https://filmvaultbackend-xpgy.onrender.com/get-related-contentS/${category2}`
    ),
    axios.get(
      `https://filmvaultbackend-xpgy.onrender.com/get-related-contentS/${category3}`
    ),
  ]);
