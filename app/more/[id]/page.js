            ...
            <div className="absolute -bottom-10 left-10 overflow-hidden w-fill">
              <div className="flex">
                ...
                <div>
                  ...
                  <div className="text-white ml-8">{data.description}</div>
                </div>
              </div>
            </div>
          </div>
                  ...
                  >
                    ...
                    <div className="flex justify-center mt-4 mb-4 flex-wrap w-full">
                      {item.episodes.map((item2, index2) => {
                        console.log(item2);
                        return (
                          <div key={index2} className="w-1/7 mb-4 ">
                            {Object.keys(item2).map(
                              (episodeKey, episodeIndex) => {
                                return (
                                  <div
                                    className="text-white font-sans hover:font-bold flex"
                                    key={episodeIndex}
                                  >
                                    <div className="py-2 px-4 bg-gray-600 mx-3 rounded-lg ">
                                      <a
