    ...
    const fetchAll = async () => {
      ...
      try {
        const [resAm, resAiom, resAiome, resAiokd] = await Promise.all([
          axios.get(
            `https://filmvaultbackend-1.onrender.com/searchAm?title=${key}&skip=${skip}&limit=${limit}&currentPage=${currentPage}`
          ),
          axios.get(
            `https://filmvaultbackend-1.onrender.com/searchAiom?title=${key}&skip=${skip}&limit=${limit}&currentPage=${currentPage}`
          ),
          axios.get(
            `https://filmvaultbackend-1.onrender.com/searchAiome?title=${key}&skip=${skip}&limit=${limit}&currentPage=${currentPage}`
          ),
          axios.get(
            `https://filmvaultbackend-1.onrender.com/searchAiokd?title=${key}&skip=${skip}&limit=${limit}&currentPage=${currentPage}`
          ),
        ]);
